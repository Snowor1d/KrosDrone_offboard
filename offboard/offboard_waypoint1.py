...
class OffboardControl(Node):
    ...
    def timer_callback(self) -> None:
        ...
        if (self.mission_state == "BOOT"):
            ...
            # vel = 2
            # yaw = 0
            self.goto_waypoint(self.lines_ned[LINE]["line_start_point"][0], self.lines_ned[LINE]["line_start_point"][1], TAKEOFF_HEIGHT, VELOCITY)
            ...
            # vel = 2
            # yaw = 0
            self.goto_waypoint(self.lines_ned[LINE]["line_end_point"][0], self.lines_ned[LINE]["line_end_point"][1], TAKEOFF_HEIGHT, VELOCITY)
            if self.is_departed == 1:
